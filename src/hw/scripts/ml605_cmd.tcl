# 
# Project automation script for ml605_cmd 
# 
# Created for ISE version 14.6
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source ml605_cmd.tcl), then you can
...
set myProject "ml605_cmd"
set myScript "ml605_cmd.tcl"  
set ENET 0
...
proc add_source_files {} {
   ...
   xfile add "/usr/include/fpga/ipcore_dir/data_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/data_fifo.v"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_rd_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_rd_fifo.v"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_stream_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_stream_fifo.v"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_top.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_user_memory.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_user_memory.v"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_wr_stream_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/ddr_wr_stream_fifo.v"
   xfile add "/usr/include/fpga/ipcore_dir/dp_ram.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/dp_ram_blank.v"
   xfile add "/usr/include/fpga/ipcore_dir/rx_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/rx_fifo_blank.v"
   xfile add "/usr/include/fpga/ipcore_dir/sys_mon.v"
   xfile add "/usr/include/fpga/ipcore_dir/track_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/track_fifo.v"
   xfile add "/usr/include/fpga/ipcore_dir/tx_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/tx_fifo_blank.v"
   xfile add "/usr/include/fpga/ipcore_dir/user_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/user_fifo.v"
   xfile add "/usr/include/fpga/ipcore_dir/user_strm_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/user_strm_fifo.v"
   xfile add "/usr/include/fpga/ipcore_dir/v6_emac_v2_2_fifo_block.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/v6_emac_v2_3.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/v6_pcie_v2_5.ngc"
   xfile add "/usr/include/fpga/source/clock_gen/mmcm_drp.v"
   xfile add "/usr/include/fpga/source/clock_gen/user_clock_gen.v"
   xfile add "/usr/include/fpga/source/enet_if/enet_ddr_ctrl.v"
   xfile add "/usr/include/fpga/source/enet_if/eth_rcr_unpack.v"
   xfile add "/usr/include/fpga/source/enet_if/eth_tcr_pack.v"
   xfile add "/usr/include/fpga/source/enet_if/ethernet_controller.v"
   xfile add "/usr/include/fpga/source/enet_if/ethernet_controller_top.v"
   xfile add "/usr/include/fpga/source/enet_if/ethernet_top.v"
   xfile add "/usr/include/fpga/source/enet_if/reset_sync.v"
   xfile add "/usr/include/fpga/source/enet_if/v6_emac_v2_2_fifo_block.v"
   xfile add "/usr/include/fpga/source/memory_if/four_port_ddr_ctrl.v"
   xfile add "/usr/include/fpga/source/memory_if/v6_ddr_top.v"
   xfile add "/usr/include/fpga/source/multiboot_ctrl/multiboot_ctrl.v"
   xfile add "/usr/include/fpga/source/pcie_if/mem_ctrl.v"
   xfile add "/usr/include/fpga/source/pcie_if/pcie_app.v"
   xfile add "/usr/include/fpga/source/pcie_if/pcie_ddr_dma_controller.v"
   xfile add "/usr/include/fpga/source/pcie_if/reg_file.v"
   xfile add "/usr/include/fpga/source/pcie_if/rx_engine.v"
   xfile add "/usr/include/fpga/source/pcie_if/tx_engine.v"
   xfile add "/usr/include/fpga/source/pcie_if/v6_pcie_top.v"
   xfile add "/usr/include/fpga/source/pcie_if/v6_pcie_v2_5.v"
   xfile add "/usr/include/fpga/source/switch_top.v"
   xfile add "/usr/include/fpga/source/top.v"
   xfile add "/usr/include/fpga/source/user_logic_if/user_ddr_stream_generator.v"
   xfile add "/usr/include/fpga/source/user_logic_if/user_ddr_strm_arbitrator.v"
   xfile add "/usr/include/fpga/source/user_logic_if/user_dma_req_arbitrator.v"
   xfile add "/usr/include/fpga/source/user_logic_if/user_logic_top.v"
   xfile add "/usr/include/fpga/source/user_logic_if/user_pcie_stream_generator.v"
   xfile add "user_logic.v"
   if {$ENET == 1} {
   xfile add "/usr/include/fpga/source/v6_enet.ucf"
   }
   xfile add "/usr/include/fpga/source/v6_top.ucf"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Configuration Rate" "40" -process "Generate Programming File"
   ...
   project set "Last Applied Strategy" "SmartXplorer - Map Logic Opt and Reg Duplication;F:/RESEARCH/2.my_git/fpgaflow/FPT2013/HW/FPGA/ISE/maplogoptregdup_old.xds"
   ...
   project set "Target UCF File Name" "/usr/include/fpga/source/v6_top.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Macro Search Path" "ipcore_dir" -process "Translate"
