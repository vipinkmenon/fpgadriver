...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>fpgaflow/FPT2013/SW/linux/application/load_config.sh at 4a3786721ec64c7160f9cc7b8c35c2c64dfd1e0a · archntu/fpgaflow</title>
...
<meta content="WjcpoTwlvuEBGckLoE+tTeX5FXNCYJJ9hygobDy+REA=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-d35b02ba3940bde9b9f2c3e58f2dfb1ceff5886c.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="62ceebebd58178eb42bf64d77d6e4d30">
        ...
        <link data-pjax-transient rel='permalink' href='/archntu/fpgaflow/blob/4a3786721ec64c7160f9cc7b8c35c2c64dfd1e0a/FPT2013/SW/linux/application/load_config.sh'>
...
<!-- blob contrib key: blob_contributors:v21:529496f1f749aac1bb9c58cf501d02ff -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:529496f1f749aac1bb9c58cf501d02ff -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/archntu/fpgaflow/blob/master/FPT2013/SW/linux/application/load_config.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" data-skip-pjax="true" rel="nofollow" title="master">master</a>
            </div> <!-- /.select-menu-item -->
        </div>
          ...
          <form accept-charset="UTF-8" action="/archntu/fpgaflow/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="WjcpoTwlvuEBGckLoE+tTeX5FXNCYJJ9hygobDy+REA=" /></div>
            ...
            <input type="hidden" name="path" id="branch" value="FPT2013/SW/linux/application/load_config.sh" />
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/archntu/fpgaflow/raw/4a3786721ec64c7160f9cc7b8c35c2c64dfd1e0a/FPT2013/SW/linux/application/load_config.sh" class="button minibutton " id="raw-url">Raw</a>
            <a href="/archntu/fpgaflow/blame/4a3786721ec64c7160f9cc7b8c35c2c64dfd1e0a/FPT2013/SW/linux/application/load_config.sh" class="button minibutton ">Blame</a>
          <a href="/archntu/fpgaflow/commits/4a3786721ec64c7160f9cc7b8c35c2c64dfd1e0a/FPT2013/SW/linux/application/load_config.sh" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L2" rel="#L2">2</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="c">#/bin/bash</span></div><div class='line' id='LC2'>cp ~/workspace/config /sys/bus/pci/devices/*<span class="k">$(</span>lspci | grep Xilinx | awk <span class="s1">&#39;{print $1}&#39;</span><span class="k">)</span>/ </div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.27196s from fe17.rs.github.com">GitHub</span>, Inc.</li>
