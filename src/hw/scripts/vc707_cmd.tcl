# 
# Project automation script for VC_707 
# 
# Created for ISE version 14.6
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source V7_Pci_Axi_Switch.tcl), then you can
...
set myProject "vc_707_cmd"
set myScript "vc_707_cmd.tcl"
set ENET 0
...
proc add_source_files {} {
   ...
   xfile add "/usr/include/fpga/ipcore_dir/pcie_7x_v1_8.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/rx_fifo.ngc"
   xfile add "/usr/include/fpga/ipcore_dir/rx_fifo_blank.v"
   xfile add "/usr/include/fpga/ipcore_dir/system_mon.v"
   ...
   xfile add "/usr/include/fpga/ipcore_dir/v7_ddr_top.ngc"
   ...
   xfile add "/usr/include/fpga/source/enet_if/v7_emac_controller.v"
   xfile add "/usr/include/fpga/source/enet_if/v7_enet_top.v"
   xfile add "/usr/include/fpga/source/enet_if/v7_ethernet_controller.v"
   xfile add "/usr/include/fpga/source/enet_if/v7_ethernet_controller_top.v"
   xfile add "/usr/include/fpga/source/enet_if/v7_ethernet_top.v"
   xfile add "/usr/include/fpga/source/memory_if/four_port_ddr_ctrl.v"
   xfile add "/usr/include/fpga/source/memory_if/v7_ddr.v"
   xfile add "/usr/include/fpga/source/memory_if/v7_ddr_top.v"
   xfile add "/usr/include/fpga/source/multiboot_ctrl/multiboot_ctrl.v"
   xfile add "/usr/include/fpga/source/pcie_if/mem_ctrl.v"
   xfile add "/usr/include/fpga/source/pcie_if/pcie_7x_v1_8.v"
   xfile add "/usr/include/fpga/source/pcie_if/pcie_7x_v1_8_pipe_clock.v"
   ...
   xfile add "/usr/include/fpga/source/pcie_if/v7_pcie_top.v"
   ...
   xfile add "/usr/include/fpga/source/v7_top.ucf"
   xfile add "user_logic.v"
   if {$ENET == 1} {
   xfile add "/usr/include/fpga/source/v7_enet.ucf"
   }
   puts ""
...
proc set_process_props {} {
   ...
   project set "BPI Sync Mode" "Type1" -process "Generate Programming File"
   ...
   project set "Enable External Master Clock" "Divide by 1" -process "Generate Programming File"
   ...
   project set "Target UCF File Name" "/usr/include/fpga/source/v7_top.ucf" -process "Back-annotate Pin Locations"
